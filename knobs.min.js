  ...
  `;
	...
	Knobs.prototype = {
	  ...
	  getCSSVariables({
	    ...
	    const baseColor = colorPicker.exports.CSStoHSLA(colorPicker.exports.changeColorFormat(vars['base-color'], 'hsl'));
	...
	exports.changeColorFormat = colorPicker.exports.changeColorFormat;
