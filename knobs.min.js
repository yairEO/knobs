	    ...
	    (knobsData || this._knobs).forEach(d => {
	      ...
	      var inputElm = this.getInputByName(d.__name),
	        ...
	        target: inputElm
	          ...
	          resetTitle;
	      if (d.type == 'select') inputElm.parentNode.style.setProperty('--value', d.value);
