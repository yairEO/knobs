	  ...
	  return knobs.map(k => {
	    if (k && k.type) {
	      ...
	      if (persistedData) {
	        ...
	        if (thisKnobPersistedData) return thisKnobPersistedData;
	      }
	      if (k.type == 'range') {
	        k.value = +k.value;
  ...
  `;
	...
	Knobs.prototype = {
	  ...
	  toggleKnob(name, isToggled) {
	    ...
	    keyVal = isToggled ? key == 'checked' ? knobData.checked : knobData.value : key == 'checked' ? knobData.defaultChecked : knobData.defaultValue;
