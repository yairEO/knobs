...
`;
  ...
  `;
	...
	function bindEvents() {
	  ...
	  [['form', 'change'], ['form', 'input'], ['form', 'reset'], ['form', 'submit'], ['form', 'focusin'], ['form', 'transitionend'], ['scope', 'click'], ['scope', 'wheel'], ['mainToggler', 'change', this.eventsRefs.mainToggler]].forEach(([elm, event, cb]) => this.DOM[elm] && this.DOM[elm].addEventListener(event, cb || this.eventsRefs[event].bind(this), {
	    passive: false
	  }));
	}
	function onFocus(e) {
